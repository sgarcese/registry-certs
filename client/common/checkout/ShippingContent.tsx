...
export default class ShippingContent extends React.Component<Props> {
  ...
  private readonly formikRef = React.createRef<FormikProps<ShippingInfo>>();
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Formik
          innerRef={this.formikRef as any}
      ...
      <form method="post" onSubmit={handleSubmit}>
        ...
        <div className="g g--r g--vc">
          ...
          <div className="g--7 m-b500">
            {this.props.certificateType === 'death' ? (
              <Link href="/death/cart" style={{ fontStyle: 'italic' }}>
                ← Back to cart
              </Link>
            ) : (
              <Link
                href={`/${this.props.certificateType}/review`}
